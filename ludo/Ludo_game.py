...
logo = PhotoImage(file="ludo/whitebox.gif")      # Loading all the image files that are required in the game.
logo2 = PhotoImage(file="ludo/red side.gif")     # Loading all the image files that are required in the game.
logo3 = PhotoImage(file="ludo/red.gif")          # Loading all the image files that are required in the game.
logo4 = PhotoImage(file="ludo/blue side.gif")
logo5 = PhotoImage(file="ludo/green side.gif")
logo6 = PhotoImage(file="ludo/yellow side.gif")
logo7 = PhotoImage(file="ludo/center.gif")
logoxx = PhotoImage(file="ludo/test.gif")
logog = PhotoImage(file="ludo/greenbox.gif")
logogs = PhotoImage(file="ludo/greenstop.gif")
logoy = PhotoImage(file="ludo/yellowbox.gif")
logoys = PhotoImage(file="ludo/yellowstop.gif")
logob = PhotoImage(file="ludo/bluebox.gif")
logobs = PhotoImage(file="ludo/bluestop.gif")
logor = PhotoImage(file="ludo/redbox.gif")
logors = PhotoImage(file="ludo/redstop.gif")
logoh = PhotoImage(file="ludo/head.gif")
logot = PhotoImage(file="ludo/tail.gif")
logoh1 = PhotoImage(file="ludo/head1.gif")
logot1 = PhotoImage(file="ludo/tail1.gif")
logoh2 = PhotoImage(file="ludo/head2.gif")
logot2 = PhotoImage(file="ludo/tail2.gif")
logoh3 = PhotoImage(file="ludo/head3.gif")
logot3 = PhotoImage(file="ludo/tail3.gif")
logoab= PhotoImage(file="ludo/blue.gif")
logoay= PhotoImage(file="ludo/yellow.gif")
logoag= PhotoImage(file="ludo/green.gif")
